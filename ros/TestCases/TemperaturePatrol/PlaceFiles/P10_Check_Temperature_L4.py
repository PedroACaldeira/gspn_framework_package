...
class MinimalActionServer(object):
    ...
    def execute_callback(self, goal):
        ...
        results_file.write("Place 10.1: " + str(psutil.cpu_percent(interval=1)) + " and " + str(psutil.virtual_memory().percent) + '\n')
        results_file.close()
        ...
        results_file = open("/home/pedro/catkin_ws/src/gspn_framework_package/ros/TestCases/TemperaturePatrol/Results/4_robot_execution_results.txt", 'a')
        results_file.write("Place 10.2: " + str(psutil.cpu_percent(interval=1)) + " and " + str(psutil.virtual_memory().percent) + '\n')
        results_file.close()
