...
class MinimalActionServer(object):
    ...
    def __init__(self, name):
        ...
        self._as.start()
        rospy.loginfo('DECIDE L2 SERVER : MEGA ONLINE')
        self._as.start()
    ...
    def execute_callback(self, goal):
        print("P7 immediate place running.")
        self._result.transition = 'None'
        rospy.loginfo('DECIDE L2 SERVER : Returning result: {0}'.format(self._result.transition))
