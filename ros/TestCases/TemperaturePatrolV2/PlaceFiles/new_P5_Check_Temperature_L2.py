...
class MinimalActionServer(object):
    ...
    def __init__(self, name, _namespace):
        ...
        self._as.start()
        rospy.loginfo('CHECK TEMPERATURE L2 SERVER : ONLINE')
        self._as.start()
    ...
    def goal_callback(self, goal_request):
        ...
        self.get_logger().info('CHECK TEMPERATURE L2 SERVER : Received goal request')
        return GoalResponse.ACCEPT

    def cancel_callback(self, goal_handle):
        """Accepts or rejects a client request to cancel an action."""
        self.get_logger().info('CHECK TEMPERATURE L2 SERVER : Received cancel request')
        return CancelResponse.ACCEPT

    def execute_callback(self, goal):
        """Executes a goal."""
        rospy.loginfo('CHECK TEMPERATURE L2 SERVER : Executing goal...')
        success = True
        ...
        if not wait:
            ...
            self._result.transition = 't9:Temperature_Low_L2'
